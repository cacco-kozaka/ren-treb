...
def main():
    ...
    parser.add_argument("--bert_model", default=model_name, type=str)
    parser.add_argument("--task_name", default='ner', type=str)
    parser.add_argument("--output_dir", default='out_ner', type=str)
    ...
    parser.add_argument("--eval_on", default="dev")
